...
import { useAddTaskMutation, useGetTasksQuery,useDeleteTaskMutation, useUpdateTaskMutation } from "./apiSlice";
export default function Home() {
  ...
  return (
    <div className="flex h-screen flex-grow items-start justify-center bg-gray-900 p-4">
      ...
      <Link to="contact" className="text-yellow-50 hover:text-gray-400 absolute">Contact</Link>
    </div>
  );
}
